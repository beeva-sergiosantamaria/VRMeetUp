...
var xAxis = 0.2;//dimensiones x
var yAxis = 0.2;//dimensiones y
var zAxis = 0.2;//dimensiones z
...
var cube = new THREE.Mesh( cubegeometry, CUBEmaterial );
	...
	cube.position.set(0,0,-2); //position del objeto(x,y,z)
	cube.rotation.set(0,0.2,0); //rotacion del objeto(x,y,z)
...
var circleradius = 0.5; //radio del circulo
var circlesegments = 64;	//numero de segmentos que forman el circulo
...
var circle = new THREE.Mesh( circleGeometry, CIRCLEmaterial );
	...
	circle.position.set(0,0,-2);	//posicion del objeto(x,y,z)
	circle.rotation.set(0,0.2,0);	//rotacion del objeto(x,y,z)
...
var CIRCUNFERENCEinnerRadius = 0.3; //radio de la parte interna de la circunferencia
var CIRCUNFERENCEouterRadius = 0.5; //radio de la parte externa de la circunferencia, la diferencia entre ambos define el grosor
var CIRCUNFERENCESegments = 64; //segmentos utilizados para dibujar la circunferencia
...
var circunference = new THREE.Mesh( CIRCUNFERENCEgeometry, CIRCUNFERENCEmaterial );
	...
	circunference.position.set(0,0,-2);	//position del objeto(x,y,z)
	circunference.rotation.set(0,0.2,0);	//rotacion del objeto(x,y,z)
...
var DONUTradius = 0.3; //radio del anillo
var DONUTtubeWidth = 0.1;	//ancho del anillo
var DONUTradialSegments = 64;	//segmentos usados para dibujar el anillo
...
var donut = new THREE.Mesh( DONUTgeometry, DONUTmaterial );
	...
	donut.position.set(0,0,-2);	//position del objeto(x,y,z)
	donut.rotation.set(0,0.4,0);	//rotacion del objeto(x,y,z)
...
var CYLINDERradiusTop = 0.2; //radio de la parte superios del cilindro
var CYLINDERradiusBottom = 0.2;	//radio de la parte inferior del cilindro
var CYLINDERheigth = 1;	//altura del cilindro
var CYLINDERradioSegments = 64; //segmentos utilizados para dibujar el cilindro(cuantos mas segmentos mas redondo)
...
var cylinder = new THREE.Mesh( CYLINDERgeometry, CYLINDERmaterial );
	...
	cylinder.position.set(0,0,-2);	//position del objeto(x,y,z)
	cylinder.rotation.set(0.4,0,0);	//rotacion del objeto(x,y,z)
...
var planexAxis = 8;//dimensiones x
var planeyAxis = 8;//dimensiones y
var planezAxis = 8;//dimensiones z
...
var SPHEREradius = 0.3; //dimensiones de la esfera
var SPHEREwidthSegments = 64;	//segmentos usados para dibujar la esfera, cuantos mas segmentos mas redonda pero mas pesada de dibujar
var SPHEREheigthSegments = 64;	////segmentos usados para dibujar la esfera, cuantos mas segmentos mas redonda pero mas pesada de dibujar
...
var sphere = new THREE.Mesh( SPHEREgeometry, SPHEREmaterial );
	...
	sphere.position.set(0,0,-2);	//position del objeto(x,y,z)
